  ...
  },
{
  ...
  $.extend(EmojiPicker.prototype, {
    ...
    updatePosition: function() {
      ...
      */
      ...
      //changing top css to make picker open above
      var txt_area_offset = $('textarea.emojiable-option').offset();
      
      var final_pos = parseInt(txt_area_offset.top) - (parseInt(this.$picker.height()) + parseInt(30)); //30 is for bottom picker section which shows emoji names
      //console.log(txt_area_offset.top+' -- '+this.$picker.height()+' --- '+final_pos);
      //console.log(this.$picker.height()+' -- '+diffOffset.top+' ---- '+elOffset.top);
  ...
  function getPickerHTML() {
    ...
    // Re-Sort Emoji table
    $.each(emoconArr, function(i, emoji) {
